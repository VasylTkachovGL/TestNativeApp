...
void UacDevice::loopback(unsigned char * data, unsigned char * dataOut, size_t size)
{
    device.loopback(AUDIO_INPUT_STREAMING_EP, AUDIO_OUTPUT_STREAMING_EP, data, dataOut, size, INPUT_PACKET_SIZE, OUTPUT_PACKET_SIZE);
}
